...
<CardGroup cols={2}>
  <Card title="Create Custom Agents" icon="robot" href="/agents/creating-agents">
  ...
  <Card title="Terminal UI" icon="terminal" href="/cli/tui">
    Explore the full-featured terminal dashboard
  </Card>
</CardGroup>
